...
export function Users(allUsers: User[]) {
    ...
    React.useEffect(() => {
        if (isMultipleSelect) setSelectionMode("multiple");
    }, [isMultipleSelect]);
    ...
    const renderCell = React.useCallback((user: User, columnKey: React.Key) => {
        ...
        switch (columnKey) {
            case "name":
                return (
                    <User
                        avatarProps={{radius: "full", size: "sm", src: user.userAvatar}}
                        classNames={{
    ...
    }, [filterValue, onSearchChange, statusFilter, visibleColumns, users.length, onRowsPerPageChange]);
